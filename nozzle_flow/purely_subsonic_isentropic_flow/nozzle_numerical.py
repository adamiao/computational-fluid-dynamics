from nozzle_flow.purely_subsonic_isentropic_flow.constants import ITERATIONS, PRESSURE_EXIT_RATIO
from nozzle_flow.purely_subsonic_isentropic_flow.initial_and_boundary_conditions import (
    initial_conditions,
...
def run_solver(rho, u, T):
    ...
    enforce_boundary_conditions(rho, u, T, pressure_exit_ratio=PRESSURE_EXIT_RATIO)
